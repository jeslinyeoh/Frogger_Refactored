...
public class Level {
	...
	public void runLevel1() {
		...
		myStage.add(new Log("file:Images/log3.png", 0, 329, 1, 150));
	...
	public void runLevel2() {
		...
		myStage.add(new Log("file:Images/log3.png", 50, 329, 1, 150));
		myStage.add(new Log("file:Images/log3.png", 270, 329, 1, 150));
		myStage.add(new Log("file:Images/log3.png", 490, 329, 1, 150));
	...
	public void runLevel3() {
		...
		myStage.add(new Log("file:Images/logs.png", 0, 275, 1, 300));
		myStage.add(new Log("file:Images/logs.png", 400, 275, 1, 300));
		...
		myStage.add(new Vehicle("file:Images/car1Right.png", 500, 597, 6, 50, 50));
	...
	public void runLevel4() {
		...
		myStage.add(new Log("file:Images/log3.png", 0, 277, 1, 150));
		myStage.add(new Log("file:Images/log3.png", 220, 277, 1, 150));
		myStage.add(new Log("file:Images/log3.png", 450, 277, 1, 150));
		...
		myStage.add(new Vehicle("file:Images/car1Left.png", 100, 490, -6, 50, 50));
		
		myStage.add(new Vehicle("file:Images/car1Right.png", 100, 540, 5, 50, 50));
		myStage.add(new Vehicle("file:Images/car1Right.png", 400, 540, 5, 50, 50));
		
		myStage.add(new Vehicle("file:Images/truck2Left.png", 0, 597, -2, 200, 200));
		myStage.add(new Vehicle("file:Images/truck2Left.png", 250, 597, -2, 200, 200));
		
		myStage.add(new Vehicle("file:Images/truck1Right.png", 0, 650, 3, 120, 120));
		myStage.add(new Vehicle("file:Images/truck2Right.png", 300, 650, 3, 200, 200));
	...
	public void runLevel5() {
		...
		myStage.add(new Log("file:Images/log3.png", 0, 222, -2, 150));
		myStage.add(new Log("file:Images/log3.png", 350, 222, -2, 150));
		...
		myStage.add(new Log("file:Images/log3.png", 100, 325, -2, 150));
		myStage.add(new Log("file:Images/log3.png", 400, 325, -2, 150));
		...
		myStage.add(new Vehicle("file:Images/car1Left.png", 100, 490, -6, 50, 50));
		myStage.add(new Vehicle("file:Images/car1Left.png", 300, 490, -6, 50, 50));
		
		myStage.add(new Vehicle("file:Images/truck1Right.png", 0, 540, 3, 120, 120));
		myStage.add(new Vehicle("file:Images/truck1Right.png", 250, 540, 3, 120, 120));
		myStage.add(new Vehicle("file:Images/truck1Right.png", 650, 540, 3, 120, 120));
		
		myStage.add(new Vehicle("file:Images/car1Left.png", 200, 597, -6, 50, 50));
		
		myStage.add(new Vehicle("file:Images/truck1Right.png", 50, 650, 3, 120, 120));
		myStage.add(new Vehicle("file:Images/truck2Right.png", 300, 650, 3, 200, 200));
	...
	public void runLevel6() {
		...
		myStage.add(new Log("file:Images/log3.png", 0, 285, -2, 300));
		myStage.add(new Log("file:Images/log3.png", 400, 285, -2, 300));
	...
	public void runLevel7() {
		...
		myStage.add(new Vehicle("file:Images/car1Left.png", 100, 485, -2.5, 50, 50));
		myStage.add(new Vehicle("file:Images/car1Left.png", 250, 485, -2.5, 50, 50));
		myStage.add(new Vehicle("file:Images/car1Left.png", 500, 485, -2.5, 50, 50));
		...
		myStage.add(new Vehicle("file:Images/truck2Right.png", 0, 649, 2, 200, 200));
		myStage.add(new Vehicle("file:Images/truck1Right.png", 500, 649, 2, 120, 120));
	...
	public void runLevel8() {
		...
		myStage.add(new Log("file:Images/log3.png", 150, 330, 1, 300));
		
		
		myStage.add(new Vehicle("file:Images/car1Right.png", 500, 490, 6, 100, 100));
		
		myStage.add(new Vehicle("file:Images/car1Left.png", 100, 565, -2, 35, 35));
		myStage.add(new Vehicle("file:Images/car1Left.png", 250, 565, -2, 35, 35));
		myStage.add(new Vehicle("file:Images/car1Left.png", 500, 565, -2, 35, 35));
		
		myStage.add(new Vehicle("file:Images/truck1Right.png", 500, 595, 3.5, 60, 60));
		myStage.add(new Vehicle("file:Images/truck1Right.png", 200, 595, 3.5, 60, 60));
	
		myStage.add(new Vehicle("file:Images/car1Left.png", 100, 620, -3, 100, 100));
		myStage.add(new Vehicle("file:Images/car1Left.png", 520, 620, -3, 100, 100));
	...
	public void runLevel10() {
		...
		myStage.add(new Vehicle("file:Images/truck1Left.png", 200, 500, -3.5, 200, 250));
		myStage.add(new Vehicle("file:Images/car1Left.png", 450, 485, -3.5, 50, 50));
		myStage.add(new Vehicle("file:Images/car1Left.png", 540, 510, -3.5, 50, 50));
		myStage.add(new Vehicle("file:Images/car1Left.png", 608, 550, -3.5, 50, 50));
		
		myStage.add(new Vehicle("file:Images/car1Right.png", 100, 600, 2.5, 50, 50));
